...
/**
 * `engine: "gadget"` is a reserved-but-unsupported enum value in Platform 0.1
 ...
 */
export class GadgetRenderer implements RendererLifecycle {
  async mount(_container: HTMLElement, _context: MountContext): Promise<void> {
    throw new RendererUnsupportedError("GadgetRenderer");
  }
